...
module completions {
  ...
  export extern "git pull" [
    ...
    --prune                                         # prune locally removed refs
    --quiet(-q)                                     # be more quiet
    --rebase: string                                # [=false|true|merges|interactive]
    --set-upstream(-u)                              # set upstream for git pull/status
    --gpg-sign(-S): string                          # GPG sign the pull
    --tags(-t)                                      # push tags (can't be used with --all or --mirror)
    --verbose(-v)                                   # be more verbose
    --help                                          # Display the help message for this command
  ]
  ...
  export extern "git rebase" [
    ...targets: string@"nu-complete git branches"   # name of the branch or files to rebase
    --continue
    --skip
    --abort
    --quiet
    ...
    --interactive(-i)
    --exec: string
    --onto: string@"nu-complete git branches"
    --keep-base
    --force-rebase(-f)                              # force checkout (throw away local modifications)
    --merge(-m)                                     # perform a 3-way merge with the new branch
    --quiet(-q)                                     # suppress progress reporting
    --help                                          # Display the help message for this command
  ]
